...
strtpath = '/Users/khan113/36x24r/c1/2D_Model-master/';  %Your saved 2D_Model-master location
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%ENTER PATH TO THIS TORUS PLOTS FOLDER HERE%%%%%%%%%%%%
f_path = '/Users/khan113/Documents/MATLAB/torus_plots/functions/';  %Your saved torus_plots location
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mkdir(strcat(strtpath,'../ouput_plots'));
